      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Situado a solo 250 metros de la PLAYA y 200 metros de la Peatonal. El hotel de 2 estrellas cuenta con 18
            habitaciones.
          </p>
        </motion.div>
        ...
        >
          ...
          <ServiceCard
            ...
            description="Dispenser de agua fría/caliente, heladera y microondas a disposición para todos los huéspedes."
            variants={itemVariants}
          />
...
function ServiceCard({ icon, title, description, variants }: ServiceCardProps) {
  return (
    <motion.div variants={variants} className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
